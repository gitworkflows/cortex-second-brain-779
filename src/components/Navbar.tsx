...
import { Brain, LogIn, Search, Upload, User, Settings, LogOut, Moon, Sun, Table, Info, HelpCircle, Code, Workflow, MapPin } from 'lucide-react';
...
export const Navbar = () => {
  ...
  const authNavItems = [
    ...
    { to: '/workflows', icon: <Workflow size={20} />, label: 'Workflows', id: 'workflows' },
    { to: '/mindmap', icon: <MapPin size={20} />, label: 'Mind Map', id: 'mindmap' },
